...
var t = class _t extends e.Component {
  constructor(t2) {
    super(t2), this.wrapperRef = void 0, this.bottomRef = void 0, this.bottomRef = e.createRef(), this.wrapperRef = e.createRef(), this.handleScroll = this.handleScroll.bind(this), console.log("Component cstr");
  }
